...
newdata$AM_PM <- stringr::word(newdata$Time, 2) 


  
newdata$fixedTime <- ifelse(newdata$AM_PM =="PM",
                            newdata$rawTime + (12 * 60 * 60), # if PM add 12 hours
                            newdata$rawTime # otherwise don't
                            ) 
newdata$fixedHMS <- hms::as_hms(newdata$fixedTime)
